...
# Parsing + Configuration Script – SC-LW-AQI - Rev. A

This **Parsing + Configuration** script is designed for the **SC-LW-AQI** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – SC-LW-AQI Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **SC-LW-AQI** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
